...
export class RegisteredDonorService {
  private donors : Donor[] = [
    ...
    new Donor('Michael', 'Taylor', 'Male', 'michael@example.com', '7774567890', 'passwordstu', '765 Place', 'Area 1', 'Government 1',DonorType.teacher),
    ...
    new Donor('Daniel', 'Perez', 'Male', 'daniel@example.com', '3336547890', 'password567', '901 Drive', 'Area 2', 'Government 2',DonorType.teacher),
  ...
  getDonorByIndex(index:number){return this.donors[index];}
